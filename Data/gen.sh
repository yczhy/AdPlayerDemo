#!/bin/bash
###
 # @Author: yczhy 1621174243@qq.com
 # @Date: 2025-11-02 09:38:10
 # @LastEditors: yczhy 1621174243@qq.com
 # @LastEditTime: 2026-05-31 23:01:53
 # @FilePath: /AdPlayerDemo/Data/gen.sh
...
"$DOTNET_CMD" "$LUBAN_DLL" \
    ...
    -x outputCodeDir=$WORKSPACE/Assets/LuBan/Scripts
